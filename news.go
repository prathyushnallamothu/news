...
func weatherhandler(w http.ResponseWriter,r *http.Request){
	resp1,err1:=http.Get("http://newsapi.org/v2/top-headlines?country=in&apiKey=e38d0ce8e7ce4039aebfcd6a634ffe9c")
	if err1!=nil{
		log.Fatal(err1)
	}
	var m Mainstruct
...
func weatherhandler2(w http.ResponseWriter,r *http.Request){
	...
	resp,err:=http.Get("http://api.openweathermap.org/data/2.5/weather?appid=c972d8745d0e1a3ef0d8a8fd4374f1ca&q="+city)
	if err!=nil{
		log.Fatal(err)
	}
	defer resp.Body.Close()
...
func categoryhandler(w http.ResponseWriter,r *http.Request){
	...
	resp,err:=http.Get("http://newsapi.org/v2/top-headlines?country=in&apiKey=e38d0ce8e7ce4039aebfcd6a634ffe9c&category="+category)
	if err!=nil{
		log.Fatal(err)
	}
	var m News
